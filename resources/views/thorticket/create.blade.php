...
<div class="card shadow" >
    <div class="card-header border-0">
        ...
        <div class="col">
            <h3 class="mb-0">Nueva Acertijo Ticket</h3>
        </div>
            ...
            <div class="row"> 
                <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <textarea name="t_pregunta1"  class="form-control" rows="10"></textarea>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group" >
                        ...
                        <textarea name="t_pregunta2"  class="form-control" rows="10"></textarea>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group" >
                        <h5>PREGUNTA N°3</h5>
                        {{-- <input type="text" name="t_respuesta1" class="form-control" value="{{old('t_respuesta1')}}" > --}}
                        <textarea name="t_pregunta3"  class="form-control" rows="10"></textarea>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="t_respuesta3" class="form-control" value="{{old('t_respuesta3')}}" />
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="t_llave1" class="form-control" value="{{old('t_llave1')}}" />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <h5 for="">LLAVE N°2 <em>(Poner en mayúscula y sin signos)</em></h5>
                      <input type="text" name="t_llave2" class="form-control"  value="{{old('t_llave2')}}" />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <h5 for="">LLAVE N°3 <em>(Poner en mayúscula y sin signos)</em> </h5>
                      <input type="text" name="t_llave3" class="form-control" value="{{old('t_llave3')}}" />
                    </div>
                </div>
            </div>
